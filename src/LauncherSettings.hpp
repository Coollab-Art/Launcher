...
private:
    Cool::JsonAutoSerializer _serializer{
        ...
        [&](nlohmann::json const& json) {
            ...
            Cool::json_get(json, "Automatically uninstall unused versions at startup", automatically_uninstall_unused_versions);
        },
        [&](nlohmann::json& json) {
            ...
            Cool::json_set(json, "Automatically uninstall unused versions at startup", automatically_uninstall_unused_versions);
        },
